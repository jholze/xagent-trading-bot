...
SELL_ACTIONS = {
    SELL_PARTIAL_10, SELL_PARTIAL_20, SELL_PARTIAL_30, SELL_PARTIAL_50, SELL_FULL, SELL_STOP,
    "SELL", "SELL_10", "SELL_20", "SELL_30", "SELL_STOP_PARTIAL", "SELL_STOP_FULL",
}
