"""Entrypoint: health server + poll loop.
  ...
  python -m services.santiment.sidecar
"""
...
# Allow `python -m services.santiment.sidecar` from repo root.
...
from services.santiment.sidecar.publisher import publish_snapshot
from services.santiment.sidecar.regime import should_push
